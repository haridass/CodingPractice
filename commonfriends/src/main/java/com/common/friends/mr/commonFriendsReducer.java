...
public class commonFriendsReducer extends Reducer<Text, Text, Text, Text> {
	...
	protected void reduce(Text key, Iterable<Text> values,
		...
		if (valArry[1] != null) {
			...
			Text outputCommonFriendsVal = new Text();
			outputCommonFriendsVal.clear();
			outputCommonFriendsVal.set(commonFriends.toString());
//			if ("A_B".equalsIgnoreCase(key.toString())) {
				context.write(key, outputCommonFriendsVal);
//			}
		}
	}
